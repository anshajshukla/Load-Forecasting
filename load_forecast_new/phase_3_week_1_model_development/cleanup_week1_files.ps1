...
foreach ($FileRelPath in $FilesToRemove) {
...
Write-Host "   .\cleanup_week1_files.ps1 -WhatIf    # Preview what will be deleted" -ForegroundColor Gray
Write-Host "   .\cleanup_week1_files.ps1            # Actually perform cleanup" -ForegroundColor Gray
